    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{ route('manageCategory.update', $category->category_id) }}" method="post" class=""
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <textarea class="ckeditor form-control" name="category_description"></textarea>
                            {{-- <input type="text" id="category_description" value="{{ $category->category_description }}"
                                name="category_description" placeholder="category_description" class="form-control"> --}}
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
